...
export default function MindMap({ initialGraphDataFromFolder, initialNodeId, mapId }: MindMapProps) {
  console.log('[DEBUG] MindMap-Original: Komponente wird gerendert!', { initialGraphDataFromFolder, initialNodeId, mapId });
  ...
  useEffect(() => {
    console.log('[DEBUG] MindMap-Original: JSX-Return, graphData:', graphData);
  }, [graphData]);
